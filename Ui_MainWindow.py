...
class mywindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def showImage_fuction(self):      # for showing image
        ...
        nozzle = cv2.imread("nozzle_2errow.PNG")
        ...
        while True :
                ...
                if flag_3step == 1:
                    ...
                    __, img, center, nozzle,Tthreshold = roi.template_3steps(frame_equ, center, nozzle,Tthreshold,extend_y)



                    #-------------- roi   已噴頭偵測框的底邊中點   大小(24，24)---------------------
                    x_leftTop = int(center[0] - 13)
                    y_leftTop = int(center[1] + 21)
